...
describe('helpers:url', () => {
    describe('buildURL', () => {
        ...
        test('should carrect discard url hash mark', () => {
    ...
    describe('isAbsoluteURL', () => {
        test('should return true if URL begins with valid', () => {
            ...
            expect(isAbsoluteURL('custom-scheme-v1.0://api.github.com/')).toBeTruthy();
            expect(isAbsoluteURL('HTTP://api.github.com/')).toBeTruthy();
        });
        test('should return false if URL begins with invalid scheme name', () => {
            expect(isAbsoluteURL('123://api.github.com/users')).toBeFalsy();
            expect(isAbsoluteURL('!valid://api.github.com/')).toBeFalsy();
        });
        test('should return true if URL is protocol-relative', () => {
            expect(isAbsoluteURL('//api.github.com/users')).toBeTruthy();
        });
